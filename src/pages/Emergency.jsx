...
const Emergency = () => {
    return (
        <div>
            ...
            <div className="max-w-[1170px] mx-auto px-4 py-24 flex lg:flex-row gap-y-8 flex-col justify-between items-start">
                <div data-aos='fade-right' className="lg:w-[800px] space-y-10">
                    <div className="grid lg:grid-cols-3 gap-4">
                        <img className="mx-auto" src="https://i.imgur.com/LIpGgh6.png" alt="" />
                        <img className="mx-auto" src="https://i.imgur.com/ACj4QFX.png" alt="" />
                        <img className="mx-auto" src="https://i.imgur.com/BgixanT.png" alt="" />
                    </div>
                    ...
                    <div className="mt-7 space-y-5 lg:space-x-5 pb-3">
                ...
                <div data-aos='fade-left' className="lg:w-[300px] -mt-1.5">
